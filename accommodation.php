		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php
					...
					$query = $conn->query("SELECT * FROM `accommodation` ORDER BY `price` ASC") or die(mysql_error());
				...
				?>
					<div class = "well" style = "height:300px; width:100%;">
						...
						<h3><?php echo "Accommodaton Id:".$fetch['accom_id']?></h3>
							<h3 style ="color:violet"><?php echo "Accommodation Type:".$fetch['accom_type']?></h3>
							<h3 style = "color:blue;"><?php echo "Price:".$fetch['price']." Rs"?></h3>
							<br /><br /><br /><br /><br /><br />
						</div>
					</div>
				<?php
