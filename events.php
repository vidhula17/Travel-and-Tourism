	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>Events you will be taken</h3></strong>
				<?php
					require_once 'admin/connect.php';
					$query = $conn->query("SELECT * FROM `event`") or die(mysql_error());
				...
				?>
					<div class = "well" style = "height:300px; width:100%;">
						...
						<div style = "float:left; margin-left:10px;">
							<h3><?php echo $fetch['event_name']?></h3>
							<h4 style = "color:blue;"><?php echo "Start date: ".$fetch['start_date']?></h4>
                            <h4 style = "color:blue;"><?php echo "End date: ".$fetch['end_date']?></h4>
							<br /><br /><br /><br /><br /><br />
						</div>
					</div>
				<?php
