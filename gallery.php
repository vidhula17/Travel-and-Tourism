	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>Have a look at some of the pictures we took during our travel!! </h3></strong>
				<?php
					require_once 'admin/connect.php';
					$query = $conn->query("SELECT * FROM `gallery`order by `photo` ") or die(mysql_error());
					while($fetch = $query->fetch_array()){
				?>
					
						<div style = "float:left;">
							<img src = "images/gallery/<?php echo $fetch['photo']?>" height = "250" width = "350"/>
						</div>
